...
class iconmoonFontAdd
{
    ...
    {
        add_action('admin_menu', array($this, 'custom_icon_upload_menu_add'));
    ...
    public function custom_icon_upload_add_icon()
    {
        ...
        add_filter('hook_name', array($this, 'custom_icon_upload_return'));
    }
    public function custom_icon_upload_return($ioon)
    {
