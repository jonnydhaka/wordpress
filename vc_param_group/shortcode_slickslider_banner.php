...
<div class="expand-btns-wrap d-none d-md-block">
				<div class="container d-flex flex-column align-items-end h-100">
					<div class="expand-btn expand-btn--social" id="expBut1">
						...
						?>
                        <a href="<?php echo $link_href ?>" class="link-<?php echo strtolower($title) ;?>" target="<?php echo $link_target?>">
						<i class="<?php echo $icon ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $title ?>"></i>
						</a>
                        <?php
						}
						?>
					...
					<div class="expand-btn expand-btn--offer" id="expBut2">
						...
						?>
                        <a href="<?php echo $link_href ?>" target="<?php echo $link_target ?>">
							<img src="<?php echo $image_url ?>" alt="<?php echo $title ?>">
							<div class="txt-wrap">
								<span class="txt-1"><span><?php echo $title ?></span> <span class="theme-color"><?php echo $title1 ?></span></span>
							</div>
						</a>
                        <?php
						}
